...
var Tab = React5.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime4.jsxs)(React5.Fragment, {
      children: [icon, label]
...
var _excluded5 = ["className", "slots", "slotProps", "direction", "orientation", "disabled"];
...
var _excluded7 = ["aria-label", "aria-labelledby", "action", "centered", "children", "className", "component", "allowScrollButtonsMobile", "indicatorColor", "onChange", "orientation", "ScrollButtonComponent", "scrollButtons", "selectionFollowsFocus", "slots", "slotProps", "TabIndicatorProps", "TabScrollButtonProps", "textColor", "value", "variant", "visibleScrollbar"];
...
var Tabs = React8.forwardRef(function Tabs2(inProps, ref) {
  ...
  const children = React8.Children.map(childrenProp, (child) => {
    ...
    childIndex += 1;
    return React8.cloneElement(child, _extends({
...
//# sourceMappingURL=chunk-SC373JSB.js.map
